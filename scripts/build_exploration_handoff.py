...
class ExplorationHandoffReport:
    ...
    def summary_frame(self) -> pd.DataFrame:
        ...
        rows = [
            ...
            {
                "Gate": "Stratified snapshot split may execute",
                "Ready": readiness["split_execution_ready"],
                "Interpretation": "The 70/15/15 class-stratified snapshot policy is resolved.",
            },
            {
...
def load_and_validate_exploration_handoff(
    ...
    *,
    ...
    classes = payload["prediction_contract"].get("target_classes", [])
